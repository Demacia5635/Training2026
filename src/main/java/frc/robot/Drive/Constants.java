...
public class Constants {
    ...
    public static final TalonConfig BASE_STEER_CONFIG = 
        new TalonConfig(0, CANBUS , "BASE_STEER")
            .withBrake(true)
            .withCurrent(15)
            ...
            .withVolts(8);
    public static final TalonConfig BASE_DRIVE_CONFIG = 
            new TalonConfig(0, CANBUS , "BASE_DRIVE")
                .withBrake(true)
                .withCurrent(30)
    ...
    static class ModuleConfig {
        ...
        ModuleConfig(int steerId, int driveId, int cancoderId, double xPosition, double yPosition, double cancoderOffset) {
