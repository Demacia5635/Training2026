...
public class Pose2d extends edu.wpi.first.math.geometry.Pose2d {
  ...
  public void set(Translation2d translation2d, Rotation2d rotation2d) {
    this.m_translation = translation2d;
    this.m_rotation = rotation2d;
  }
  ...
  public Pose2d timesSelf(double scalar) {
    m_translation.timesSelf(scalar);
    m_rotation.timesSelf(scalar);
    return this;
  }
  ...
  public Pose2d divSelf(double scalar) {
  ...
  public Pose2d rotateBySelf(Rotation2d other) {
    m_translation.rotateBySelf(other);
    m_rotation.rotateBySelf(other);
    return this;
  }
  ...
  public Pose2d rotateAroundSelf(Translation2d point, Rotation2d rot) {
    m_translation.rotateAroundSelf(point, rot);
    m_rotation.rotateBySelf(rot);
    return this;
  }
