...
public class Translation2d
  ...
  public Translation2d(double distance, Rotation2d angle) {
    set(distance * angle.getCos(), distance * angle.getSin());
  }
  ...
  public Translation2d rotateBySelf(Rotation2d other) {
    set(m_x * other.getCos() - m_y * other.getSin(), m_x * other.getSin() + m_y * other.getCos());
    return this;
  }
  ...
  public Translation2d rotateAroundSelf(Translation2d other, Rotation2d rot) {
    set(
        (m_x - other.getX()) * rot.getCos() - (m_y - other.getY()) * rot.getSin() + other.getX(),
        (m_x - other.getX()) * rot.getSin() + (m_y - other.getY()) * rot.getCos() + other.getY());
    return this;
  ...
  public Translation2d plusSelf(Translation2d other) {
    set(m_x + other.m_x, m_y + other.m_y);
    return this;
  }
  ...
  public Translation2d minusSelf(Translation2d other) {
    set(m_x - other.m_x, m_y - other.m_y);
    return this;
  }
  ...
  public Translation2d unaryMinusSelf() {
    set(-m_x, -m_y);
    return this;
  }
  ...
  public Translation2d timesSelf(double scalar) {
  ...
  public Translation2d divSelf(double scalar) {
    set(m_x / scalar, m_y / scalar);
    return this;
  }
